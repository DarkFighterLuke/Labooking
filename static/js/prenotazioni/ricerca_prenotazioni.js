...
function retrieveDataFromTable(){
    ...
    for(let i=2; i<table.rows.length; i++){
        ...
        m.set("referto", table.rows[i].cells[6].innerHTML);
        m.set("questionario", table.rows[i].cells[7].innerHTML);
        mapArray.push(m);
    }
}
...
function showSearchResults(){
    ...
    resultsTable.rows[0].insertCell(6).outerHTML="<th>Referto</th>";
    resultsTable.rows[0].insertCell(7).outerHTML="<th>Questionario anamnesi</th>";
    for(let i=0; i<foundArray.length; i++){
        ...
        resultsTable.rows[1].cells[6].innerHTML=foundArray[i].get("referto");
        resultsTable.rows[1].cells[7].innerHTML=foundArray[i].get("questionario");
    }
